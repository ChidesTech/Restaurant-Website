...
productRoute.post("/", isAuth,isAdmin, expressAsyncHandler(async(req, res)=>{
   ...
   res.send({message:"Food Created Successfull", product: createdProduct})
...
productRoute.put("/:id", isAuth, isAdmin, expressAsyncHandler(async(req,res)=>{
    ...
    if(product){
      ...
      res.send({message: "Food item was updated successfully",product : updatedProduct})

    }else{
        res.status(404).send({message: "Food Item wasn't found."})
    }
...
productRoute.delete("/:id", isAuth, isAdmin, expressAsyncHandler(async(req,res)=>{
   ...
   if(product){
      ...
      res.send({message: "Food item was deleted successfully", product: deletedProduct})
