        ...
        <main>
            <div className="cards">
                ...
                <div style={{backgroundColor: "navy", border: "2px solid navy" }}className="card-single">
                    ...
                    <div><span className="fa fa-hamburger"></span></div>
                </div>
                ...
                <div style={{backgroundColor: "green",border: "2px solid green"}} className="card-single">
                    ...
                    <div><span className="fas fa-concierge-bell"></span></div>
                </div>
                ...
                <div style={{backgroundColor: "white",border: "2px solid red"}} className="card-single">
                    <div>
                        ...
                        <span style={{color: "red"}}>Reservations</span>
                    </div>
                    <div><span style={{color: "red"}} className="far fa-clipboard"></span></div>
                </div>
