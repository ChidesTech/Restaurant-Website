...
useEffect(()=>{
    ...
    return (<div className="order-tbl">
      <h1 style={{textAlign:"center",color:"red",textShadow:"1px 1px 1px black", fontSize:"2.2rem"}}>My Order History</h1>
       ...
       (
        ...
        {orders.map((order)=>{
            ...
            <tr key={order._id}>
                ...
                <td style={{textAlign:"center"}}> <button style={{backgroundColor:"wheat",marginLeft:"10%", padding:"1.5rem 2.2rem",marginRight:"1rem",cursor:"pointer", color:"red"}} type="button" className="btn-small"
