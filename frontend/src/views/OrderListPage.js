...
const deleteHandler=(orderId)=>{
   if(window.confirm("Are you sure you want to delete this order?")){
    ...
    return (<div className="order-tbl">
      <h1 style={{textAlign:"center",color:"red",textShadow:"1px 1px 1px black", fontSize:"2.2rem"}}>Orders</h1>
    ...
    />  :
       ...
       (
           ...
           <table>
               {orders.length===0? <Popup>No food item has been ordered.</Popup>:(
<>
<thead>
    ...
    <td>{order.user !== null ? order.user.name : "User" }</td> 
                ...
                <td>   <button style={{backgroundColor:"wheat",padding:".75rem 1.5rem",marginRight:"1rem",cursor:"pointer", color:"red"}} type="button" className="btn-small"
