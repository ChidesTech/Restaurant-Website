...
props.history.push("/category-list");
  ...
  {loading ? (
          ...
          <div style={{display:"flex",justifyContent:"space-between" ,flexDirection:"row-reverse", marginTop:"1rem"}} >
              ...
              <button onClick={()=>deleteHandler(categoryId)} style={{width:"40%", backgroundColor:"transparent", borderColor:"transparent", color:"red", boxShadow:"1px 1px 1px 1px red"}} type="button" className="btn">Cancel</button>
